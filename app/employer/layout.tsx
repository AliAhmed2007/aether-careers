...
import { getJobListingApplicationJobListingTag } from "@/features/jobListingApplication/db/cache/jobListingApplication";
      ...
      content={
        <>
          <SidebarGroup>
            ...
            <AsyncIf
              condition={() => hasOrgUserPermission("org:job_listing:job_listing_create")}
            >
